<div>
    ...
    <div wire:ignore.self class="modal fade" id="addCategoria" tabindex="-1" role="dialog" aria-labelledby="ModalLabel"
         aria-hidden="true">
    ...
    <div wire:ignore.self class="modal fade" id="deleteCategoria" tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="destroyCategoria">
                        <div class="modal-body">
                            <p>Deseja deletar esta categoria?</p>
                        </div>
